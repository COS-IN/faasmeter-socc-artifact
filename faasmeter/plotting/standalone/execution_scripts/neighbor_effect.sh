...
if true; then
    python3 $base/faasmeter/plotting/standalone/neighbor_effect.py -s \
            /data2/ar/iluvatar-energy-experiments/results/trace/fig_9/desktop/mc_4f_traces_ddp_15min/mc_a/functions/fcfs/12/12 \
            /data2/ar/iluvatar-energy-experiments/results/trace/fig_9/desktop/mc_4f_traces_ddm_15min/mc_a/functions/fcfs/12/12
fi
