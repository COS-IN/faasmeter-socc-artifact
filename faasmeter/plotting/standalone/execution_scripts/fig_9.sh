...
if true; then
    python3 $base/faasmeter/plotting/standalone/combined_fig_9.py -s \
            /data2/ar/iluvatar-energy-experiments/results/trace/fig_9/desktop/mc_4f_traces_nddp_15min/mc_a/functions/fcfs/12/12 \
            /data2/ar/iluvatar-energy-experiments/results/trace/fig_9/victor/mc_4f_traces_nddp_15min/mc_a/functions/fcfs/24/24 \
            /data2/ar/iluvatar-energy-experiments/results/trace/fig_9/jetson/mc_4f_traces_nddp_15min/mc_a/functions/fcfs/12/12 \
            /data2/ar/iluvatar-energy-experiments/results/trace/fig_9/jetson/mc_4f_traces_nddpgpu_15min/mc_a/functions/fcfs/12/12
...
if false; then
    python3 /data2/ar/faasmeter/faasmeter/plotting/standalone/combined_fig_9.py -s \
