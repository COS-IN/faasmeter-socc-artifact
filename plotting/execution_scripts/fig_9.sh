...
if true; then
    python3 $base/plotting/combined_fig_9.py -s \
              ...
              $base/results/trace/fig_9/jetson/mc_4f_traces_nddpgpu_15min/mc_a/functions/fcfs/12/12
#            /extra/alfuerst/repos/iluvatar-energy-experiments/results/trace/fig_9/jetson/mc_4f_traces_ddpm_15min/mc_m/functions/fcfs/12/12

    #        /extra/alfuerst/repos/iluvatar-energy-experiments/results/trace/fig_9/victor/mc_4f_traces_ddp_15min/mc_v/functions/fcfs/24/24 \
